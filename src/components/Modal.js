...
export default function Modal() {
    const{inspectedIngredient,loading, closeModal} = useGlobalContext();
    ...
    return (
        <div className={"fixed grid place-items-center z-20 top-0 left-0 right-0 bottom-0 bg-gray-800 bg-opacity-70 h-screen"}>
                {loading ? <p>Loading ingredient info</p> :inspectedIngredient ?<div className="relative bg-white dark:bg-gray-600 border-4 border-gray-300 dark:border-indigo-100 text-center w-4/5 max-w-md lg:max-w-2xl py-20 rounded">
                     <div>
