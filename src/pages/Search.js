        ...
        <div>
                <div className="bg-hero-background hero">
                    ...
                    <form className="pt-10" id="searchForm" onSubmit={handleSubmit}>
                        <input className="border-2 border-indigo-600 py-2 px-1 rounded w-4/5 max-w-lg text-center focus: outline-none dark:bg-gray-600 dark:border-indigo-100 dark:text-indigo-200" type="text" name="searchBar" autoComplete="off" placeholder={searchType=="name"? "cocktail name" : "your ingredient"} ></input>
                    </form>
                </div>
